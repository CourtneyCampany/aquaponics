...
barplot(t(as.matrix(mass_perc2))[i,], names.arg=boxlabs2, col=c("chocolate3", "forestgreen"), width=2, xlab= "", 
...
legend("topright", inset = c(-0.305, 0), fill = c("forestgreen", "chocolate3"), legend=partlab, cex=1)
