...
boxplot(gasex$ITE ~ uniqueid, data=gasex, xaxt='n',varwidth=TRUE,
        ylab=itelab,border=trtcols,ylim=c(0,175),xlab="",outline=FALSE,
        boxlwd=2.5, whisklwd=2.5,staplelwd=2.5)
stripchart(gasex$ITE ~ uniqueid, data = gasex,
           vertical = TRUE, method = "jitter",cex=1.5,
           pch = 16,  col= trtcols2, xaxt='n', add=TRUE)
axis(1, labels=FALSE)
text(1.5, 95, "*",cex=2, font=2)
text(3.5, 168, "*",cex=2, font=2)
text(5.5, 125, "*",cex=2, font=2)
text(.5, 175, "A",cex=1.5, font=2)
